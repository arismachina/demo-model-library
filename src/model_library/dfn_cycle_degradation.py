...
def _build_pybamm_params(
...
) -> Tuple[pybamm.ParameterValues, Dict[str, str], bool]:
    """
    ...
    2. Build parameter values with thermal, voltage, and degradation settings
    ...
    return param, model_options, calibration_success
